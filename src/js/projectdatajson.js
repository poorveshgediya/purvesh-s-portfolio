...
export const projectdata = [
  ...
  },
  {
    ...
    image: Photo8,
    discripction:
      "This project is a fully functional Rich Text Editor deployed on Netlify, allowing users to create, edit, and export formatted documents effortlessly. It showcases practical skills in building intuitive web applications for text manipulation.",
    techstcak: "HTML-CSS / JavaScript / React",
    github: "https://github.com/poorveshgediya/Rich_Text_Editor",
    live: "https://rich-text-editor-purveshgediya.netlify.app/",
  },
  {
